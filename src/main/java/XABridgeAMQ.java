...
public class XABridgeAMQ {
  ...
  public static void main(String[] args) throws Exception {
    ...
    XAConnection sourceConn = createConnection("source");
    ...
    XAConnection targetConn = createConnection("target");
    ...
    if(targetSession.getXAResource().isSameRM(sourceSession.getXAResource())) {
      System.out.println("isSameRM() is bugged!");
      System.exit(1);
    }
  ...
  private static XAConnectionFactory createConnectionFactory(String clientId) throws NamingException, JMSException {  
    ActiveMQXAConnectionFactory cf = new ActiveMQXAConnectionFactory("tcp://localhost:61616");
    cf.setClientID(clientId);
    return cf;
  }
  
  private static XAConnection createConnection(String clientId) throws NamingException, JMSException {
    return createConnectionFactory(clientId).createXAConnection();
  }
